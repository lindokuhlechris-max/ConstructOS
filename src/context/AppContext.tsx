...
const DEFAULT_INITIAL_PROFILES: UserProfile[] = [
  ...
  },
  {
    ...
    email: 'inspector@constructos.io',
    phone: '+1 (555) 016-3382',
    company: 'ConstructOS Quality Assurance',
